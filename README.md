...
> **Note**
> Everywhere in this repository, make sure to replace `zindswini/zind-home-server` with the details of your own repository. Unless you used [`create-ublue-image`](https://github.com/EinoHR/create-ublue-image), in which case the previous repo identifier should already be your repo's details.
